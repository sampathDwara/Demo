...
<?php TemplateUtility::printHeader('Suppliers', array('modules/suppliers/validator.js', 'js/sweetTitles.js', 'js/listEditor.js',  'js/addressParser.js')); ?>
        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2>Suppliers: Add Supplier</h2></td>
                </tr>
            </table>

            <form name="addSupplierForm" id="addSupplierForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=suppliers&amp;a=add" method="post" onsubmit="return checkAddForm(document.addSupplierForm);" autocomplete="off">
                ...
                <table class="editTable" width="100%">
                    <tr>
                        <td class="tdVertical">
                            <label id="nameLabel" for="name">Supplier Name:</label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="arrowButton" tabindex="91" align="middle" type="button" value="&lt;--" class="arrowbutton" onclick="AddressParser_parse('addressBlock', 'company', 'addressParserIndicator', 'arrowButton'); document.addSupplierForm.name.focus();" />
                        </td>
                    </tr>
                ...
                <input type="submit" class="button" value="Add Supplier" />&nbsp;
                <input type="reset"  class="button" value="Reset" />&nbsp;
                <input type="button" class="button" value="Back to Suppliers" onclick="javascript:goToURL('<?php echo(CATSUtility::getIndexName()); ?>?m=suppliers&amp;a=show');" />
            </form>

            <script type="text/javascript">
                document.addSupplierForm.name.focus();
            </script>
        </div>
    </div>

...
class SuppliersListByViewDataGrid extends SuppliersDataGrid
{
    public function __construct($siteID, $parameters, $misc)
    {
        ...
        parent::__construct("suppliers:SuppliersListByViewDataGrid", 
...
class suppliersSavedListByViewDataGrid extends SuppliersDataGrid
{
    public function __construct($siteID, $parameters, $misc)
    {
        /* Pager configuration. */
        ...
        parent::__construct("suppliers:suppliersSavedListByViewDataGrid", 
                             $siteID, $parameters, $misc
                        );
    }

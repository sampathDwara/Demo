...
<?php TemplateUtility::printHeader('Suppliers', array('modules/suppliers/validator.js', 'js/sweetTitles.js', 'js/listEditor.js')); ?>
        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2>Suppliers: Edit Supplier</h2></td>
               </tr>
            </table>

            <form name="editSupplierForm" id="editSupplierForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=suppliers&amp;a=edit" method="post" onsubmit="return checkEditForm(document.editSupplierForm);" autocomplete="off">
                        ...
                        <td valign="top" width="50%" height="285">
                            ...
                            <table class="editTable" width="100%" height="100%">
                                <tr>
                                    ...
                                    <td class="tdData">
                                        <?php if ($this->data['defaultSupplier'] != 1): ?>
                ...
                <input type="button" class="button" name="back"   id="back"   value="Back to Details" onclick="javascript:goToURL('<?php echo(CATSUtility::getIndexName()); ?>?m=suppliers&amp;a=show&amp;companyID=<?php echo($this->companyID); ?>');" />
            </form>

            <script type="text/javascript">
                document.editSupplierForm.name.focus();
            </script>
        </div>
    </div>

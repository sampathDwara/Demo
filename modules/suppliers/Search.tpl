...
<?php TemplateUtility::printHeader('Suppliers', array('modules/suppliers/validator.js', 'js/searchSaved.js', 'js/sweetTitles.js', 'js/searchAdvanced.js', 'js/highlightrows.js', 'js/export.js')); ?>
        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2>Suppliers: Search Suppliers</h2></td>
                </tr>
            </table>

            <p class="note">Search Suppliers</p>
                ...
                <tr>
                    <td>
                        <form name="searchForm" id="searchForm" action="<?php echo(CATSUtility::getIndexName()); ?>" method="get" autocomplete="off">
                            <input type="hidden" name="m" id="moduleName" value="suppliers" />
                            ...
                            <select id="searchMode" name="mode" onclick="advancedSearchConsider();" class="selectBox">
                                <option value="searchByName"<?php if ($this->mode == "searchByName"): ?> selected<?php endif; ?>>Supplier Name</option>
                            ...
                            <input type="submit" class="button" id="searchSuppliers" name="searchSuppliers" value="Search" />
                            <?php TemplateUtility::printAdvancedSearch('searchByKeyTechnologies'); ?><br/> <br />
                    ...
                    <table class="sortable" width="100%" onmouseover="javascript:trackTableHighlight(event)">
                        <tr>
                            ...
                            <th align="left" nowrap="nowrap">
                                <?php $this->pager->printSortLink('name', 'Supplier Name'); ?>
                            </th>
                            <th align="left" nowrap="nowrap">
                        ...
                        <?php foreach ($this->rs as $rowNumber => $data): ?>
                            <tr class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">
                                <td valign="top" nowrap="nowrap">
                                    <input type="checkbox" id="checked_<?php echo($data['supplierID']); ?>" name="checked_<?php echo($data['supplierID']); ?>" />
                                    <a href="javascript:void(0);" onclick="window.open('<?php echo(CATSUtility::getIndexName()); ?>?m=suppliers&amp;a=show&amp;supplierID=<?php $this->_($data['supplierID']); ?>')" title="View in New Window">
                                        <img src="images/new_window.gif" alt="(Preview)" border="0" width="15" height="15" />
                                    </a>
                                </td>
                                <td valign="top" align="left">
                                    <a href="<?php echo(CATSUtility::getIndexName()); ?>?m=suppliers&amp;a=show&amp;supplierID=<?php $this->_($data['supplierID']); ?>" class="<?php $this->_($data['linkClass']); ?>">

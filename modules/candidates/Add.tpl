...
<!-- Start: Resume upload  --->
                    ...
                    <tr>
                        ...
                        <td class="tdVertical" colspan="2">
							<input type="button" id="loadParseValues" value="Populate Required Fields from Resume File " onclick="showPopWin('<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=CandidateParseData&amp;resumeurl=<?php echo $this->parseUrl; ?>', 400, 350, null);"  />
                        </td>

                        <td class="tdVertical">
							<input type="hidden" name="parseUrl" id="parseUrl" class="inputbox" value="<?php echo $this->parseUrl; ?>" />&nbsp;
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            ...
                            <input type="email" tabindex="3" name="email1" id="email1" class="inputbox" style="width: 150px" value="<?php if(isset($this->preassignedFields['email'])) $this->_($this->preassignedFields['email']); elseif (isset($this->preassignedFields['email1'])) $this->_($this->preassignedFields['email1']); ?>" onchange="checkEmailAlreadyInSystem(this.value);" />&nbsp;*
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            ...
                            <input type="email" tabindex="4" name="email2" id="email2" class="inputbox" style="width: 150px" value="<?php if (isset($this->preassignedFields['email2'])) $this->_($this->preassignedFields['email2']); ?>" onchange="checkEmailAlreadyInSystem(this.value);" />
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            ...
                            <input type="text" tabindex="7" name="phoneCell" id="phoneCell" class="inputbox" style="width: 150px" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}"placeholder="***-***-****" value="<?php if (isset($this->preassignedFields['phoneCell'])) $this->_($this->preassignedFields['phoneCell']); ?>" onchange="checkPhoneAlreadyInSystem(this.value);" />&nbsp;*  

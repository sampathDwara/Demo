                ...
                <tr style="vertical-align:top;">
                    ...
                    <?php endif; ?>
                        <table class="detailsInside" height="100%">
                            ...
                            <tr>
                                ...
                                <td class="data">
                                    <?php $this->_($this->data['cityAndState']); ?><br/>
                                    <?php $this->_($this->data['country']); ?>
                            ...
                            <?php endfor; ?>
                            <tr>                                <td class="vertical">Ref. Recruiter:</td>                                <td class="data"><?php $this->_($this->data['ref_recruiter']); ?></td>                            </tr>		                    <tr>		                        <td class="vertical">		                            <label id="linkedinLabel" for="linkedin">LinkedIn:</label>		                        </td>		                        <td class="data">		                            <?php if(isset($this->data['linkedin'])) $this->_($this->data['linkedin']); ?>		                        </td>		                    </tr>                            		                    <tr>		                        <td class="vertical">		                            <label id="skypeidLabel" for="skypeid">SkypeId:</label>		                        </td>		                        <td class="data">									<?php if(isset($this->data['skypeid'])) $this->_($this->data['skypeid']); ?>		                        </td>		                    </tr>		                    <tr>		                        <td class="vertical">		                            <label id="preflocationsLabel" for="preflocations">Preferred locations:</label>		                        </td>		                        <td class="data">		                            <?php if(isset($this->data['preflocations'])) $this->_($this->data['preflocations']); ?>		                        </td>		                    </tr>	                        <tr>		                        <td class="vertical">		                            <label id="visaLabel" for="visa">Visa Type:</label>		                        </td>		                        <td class="data">			                        <?php $this->_($this->data['visa']); ?>		                        </td>	                        </tr>	                        <tr>		                        <td class="vertical">		                            <label id="titleLabel" for="title">Title:</label>		                        </td>		                        <td class="data">		                            <?php if(isset($this->data['title'])) $this->_($this->data['title']); ?>		                        </td>	                        </tr>	                        <tr>		                        <td class="vertical">				                            <label id="totalExpLabel" for="totExp">Total Experience:</label>				                        </td>		                        <td class="data">		                        	<?php $this->_($this->data['totexp1']); ?> Years <?php $this->_($this->data['totexp2']); ?> Months		                        </td>	                        </tr>	                        <tr>		                        <td class="vertical">				                            <label id="relExpLabel" for="totExp">Relevant Experience:</label>				                        </td>		                        <td class="data">		                        	<?php $this->_($this->data['relexp1']); ?> Years <?php $this->_($this->data['relexp2']); ?> Months		                        </td>	                        </tr>		                    <tr>		                        <td class="vertical">				                           <label id="DomainLabel" for="Domain">Domain:</label>				                        </td>				                        <td class="data">			                        <?php $this->_($this->data['domain']); ?>		                        </td>		                    </tr>	                        		                    <tr>				                        <td class="vertical">				                           <label id="CategoryLabel" for="Category">Category:</label>				                        </td>				                        <td class="data">									<?php $this->_($this->data['category']); ?>		                        </td>				                    </tr>		                    <tr>				                        <td class="vertical">				                           <label id="rolesLabel" for="roles">Roles:</label>				                        </td>				                        <td class="data">									<?php $this->_($this->data['roles']); ?>		                        </td>				                    </tr>		                    
                            <tr>
                                <td class="vertical"></td>
                                <td class="data"></td>
                            </tr>
                    ...
                    <?php endif; ?>
                        <table class="detailsInside" height="100%">
                            ...
                            <tr>
                                <td class="vertical">Other Skills:</td>
                                <td class="data"><?php $this->_($this->data['otherSkills']); ?></td>
                            </tr>
                            <tr>
                ...
                <tr>
                    <td>
                        <table class="detailsInside">
                            ...
                            <tr>                                <td valign="top" class="vertical">Resume URL:</td>                                <td id="shortNotes" style="display:block;" class="data">                                                                <?php if(isset($this->data['resumeurl']) && !empty($this->data['resumeurl'])) {?>                                <img src="images/GoogleDrive.gif" width="16" height="16" border="0" alt="Schedule Event" class="absmiddle">                                <a href="<?php $this->_($this->data['resumeurl']); ?>" target="_blank">									<?php $this->_($this->data['firstName']); ?>																		<?php $this->_($this->data['middleName']); ?>																		<?php $this->_($this->data['lastName']); } ?>                                                               </td>                            </tr>
...
<?php if (!$this->isPopup && $this->accessLevel!= 370): ?>
            <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT): 
            ...
            <?php if ($this->accessLevel >= ACCESS_LEVEL_MULTI_SA): ?>
                <?php if ($this->data['isAdminHidden'] == 1): ?>
                    ...
                    <?php else: ?>
                    <a class="btn" href="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=administrativeHideShow&amp;candidateID=<?php echo($this->candidateID); ?>&amp;state=1">
...
<?php endif; 
 ...
 if($_SESSION['CATS']->getUserID()==$this->data['owner'] && $this->accessLevel== 370){?>
...
<?php if (!$this->isPopup): ?>
            <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT): ?>
                <a  class="btn"  href="#" onclick="showPopWin('<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=considerForJobSearch&amp;candidateID=<?php echo($this->candidateID); ?>', 750, 390, null); return false;">
...
<?php endif; ?>
            ...
            <table id="activityTable" class="sortable">
                <tr>
                    ...
                    <th align="left">Current Pay</th>
                    <th align="left">Desired Pay</th>
...
<?php endif; ?>
                ...
                <?php foreach ($this->activityRS as $rowNumber => $activityData): ?>
                    <tr class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">
                        ...
                        <td align="left" valign="top" id="activitypayCurrent<?php echo($activityData['activityID']); ?>"><?php if($activityData['contact_pay_current']) echo $activityData['contact_pay_current']; ?></td>
                        <td align="left" valign="top" id="activitypayDesired<?php echo($activityData['activityID']); ?>"><?php if($activityData['contact_pay_expectation']) echo $activityData['contact_pay_expectation']; ?> </td>
<?php if (!$this->isPopup): ?>
                        <td align="center" >
                            <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT && $this->accessLevel!= 370): ?>

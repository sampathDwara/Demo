            ...
            <?php if (!empty($this->rs)): ?>
                <table class="sortable" width="100%">
                    <tr>
                        ...
                        <th align="left">EndClient</th>
                        <th align="left">Client Ref.No</th>
                        <th align="left">Primary_Contact</th>
                    ...
                    <?php foreach ($this->rs as $rowNumber => $data): ?>
                        <tr class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">
                            ...
                            <td align="left" valign="top"><?php $this->_($data['endClient']); ?></td>
			    <td align="left" valign="top"><?php $this->_($data['Client_Ref_No']); ?></td>
			    <td align="left" valign="top"><?php $this->_($data['Primary_Contact']); ?></td>

                        ...
                        <form name="candidatesViewSelectorForm" id="candidatesViewSelectorForm" action="<?php echo(CATSUtility::getIndexName()); ?>" method="get">
                            ...
                            <table class="viewSelector">
                                <tr>
                                    ...
                                    <td valign="top" align="right" nowrap="nowrap">
                                        <input type="checkbox" name="onlyPreQualified" id="onlyPreQualified" <?php if ($this->dataGrid->getFilterValue('IsPrequalified') == '1'): ?>checked<?php endif; ?> onclick="<?php echo $this->dataGrid->getJSAddRemoveFilterFromCheckbox('IsPrequalified', '==', '\'1\''); ?>" />
                                        <label for="onlyPreQualified">Only Pre-Qualified</label>&nbsp;
                                    </td>
                                    <td valign="top" align="right" nowrap="nowrap">

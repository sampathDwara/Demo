                    ...
                    <tr>
                        <td valign="top" width="50%" height="285">
                            ...
                            <table class="editTable" width="100%" height="100%">
                                ...
                                </tr>                                <tr>                                    <td class="tdVertical">                                        <label id="isImpPartner" for="isImpPartner"></label>                                    </td>                                    <td class="tdData">                                        <?php if ($this->data['isImpPartner'] == 1): ?>                                            <input type="checkbox" id="isImpPartner" name="isImpPartner" checked />                                        <?php else: ?>                                            <input type="checkbox" id="isImpPartner" name="isImpPartner" />                                        <?php endif; ?>&nbsp;Implemetation partner                                    </td>                                </tr>
                                <tr>
                                    <td class="tdVertical">
                                        <label id="urlLabel" for="ourfee_percent">Our Fee:</label>
                                    </td>
                                    <td class="tdData">
                                        <input type="text" name="ourfee_percent" id="ourfee_percent" value="<?php $this->_($this->data['ourfee_percent']); ?>" class="inputbox" style="width: 50px" />%
                                    </td>
                                </tr>

    ...
    <div id="main">
        ...
        <div id="contents">
                ...
                <tr style="vertical-align:top;">
                    <td width="50%" height="100%">
                        <table class="detailsInside" height="100%">
                            ...
                            </tr>                            <tr>                                <td class="vertical">Implemetation partner:</td>                                <td class="data">                                        <?php if ($this->data['isImpPartner'] == 1): ?>                                            Yes                                        <?php else: ?>                                            No                                        <?php endif; ?>								</td>                            </tr>
                        ...
                        <!-- /CONTACT INFO -->
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td class="data"><?php $this->_($this->data['ourfee_percent']); ?></td>
                            </tr>
                            <tr>
                                <td class="vertical">&nbsp;</td>
                                <td class="data">&nbsp;</td>
            ...
            <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT  && $this->accessLevel!= 370 ): ?>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;
            <?php endif; ?>
            <?php if ($this->accessLevel >= ACCESS_LEVEL_DELETE && $this->data['defaultCompany'] != 1  && $this->accessLevel!= 370 ): ?>
            ...
            <?php endif; ?>
            <!-- /CONTACT INFO -->            <br clear="all" />            <br />            <!-- Location INFO -->            <p class="note">Locations</p>            <table class="sortable">                <tr>                    <th align="left" nowrap="nowrap">Country</th>                    <th align="left" nowrap="nowrap">Address</th>                    <th align="left" nowrap="nowrap">City</th>                    <th align="left">State</th>                    <th align="left">Zip</th>                    <th align="left">Created</th>                    <th align="center">Action</th>                </tr>                <?php if (count($this->locationsRS) != 0): ?>                 <?php foreach ($this->locationsRS as $rowNumber => $locationsData): ?>                    <tr id="LocationDefault<?php echo($rowNumber) ?>" class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">                        <td valign="top" align="left"><?php $this->_($locationsData['country']) ?></td>                        <td valign="top" align="left"><?php $this->_($locationsData['address']) ?></td>                        <td valign="top" align="left"><?php $this->_($locationsData['city']) ?></td>                        <td valign="top" align="left"><?php $this->_($locationsData['state']) ?></td>                        <td valign="top" align="left"><?php $this->_($locationsData['zip']) ?></td>                        <td valign="top" align="left">                        <?php                                                 	//$date = new DateTime($this->_($locationsData['date_created']));                        	$date = new DateTime($locationsData['date_created']);                        	echo $date->format('m-d-Y');                                                ?>                        </td>                        <td valign="top" align="center">                            <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT && $this->accessLevel!= 370 ): ?>								&nbsp;                                                                <a href="javascript:void(0);" onclick="showPopWin('<?php echo(CATSUtility::getIndexName()); ?>?m=companies&amp;a=addCompanyLocation&amp;companyID=<?php echo($this->companyID); ?>&amp;operation=edit&amp;locationID=<?php $this->_($locationsData['CompLocID']) ?>', 400, 350, null);" style="">                                    <img src="images/actions/edit.gif" width="16" height="16" class="absmiddle" alt="edit" border="0" />                                </a>								&nbsp;                                									<?php if (($locationsData['active']) == '1'): ?>																				<a href="javascript:void(0);" onclick="showPopWin('<?php echo(CATSUtility::getIndexName()); ?>?m=companies&amp;a=addCompanyLocation&amp;companyID=<?php echo($this->companyID); ?>&amp;operation=block&amp;locationID=<?php $this->_($locationsData['CompLocID']) ?>', 400, 350, null);" style="">			                                <img src="images/actions/screen.gif" width="16" height="16" class="absmiddle" alt="UnBlock" border="0" />			                            </a>                            			                        			                        <?php else: ?>			                        										<a href="javascript:void(0);" onclick="showPopWin('<?php echo(CATSUtility::getIndexName()); ?>?m=companies&amp;a=addCompanyLocation&amp;companyID=<?php echo($this->companyID); ?>&amp;operation=unblock&amp;locationID=<?php $this->_($locationsData['CompLocID']) ?>', 400, 350, null);" style="">			                                <img src="images/actions/screen_grey.gif" width="16" height="16" class="absmiddle" alt="Block" border="0" />			                            </a>                            			                        			                        <?php endif; ?>                            <?php endif; ?>                        </td>                    </tr>                <?php endforeach; ?>               <?php endif; ?>            </table>            <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT && $this->accessLevel!= 370 ): ?>                <!--<a href="<?php echo(CATSUtility::getIndexName()); ?>?m=companieslocation&amp;a=add&amp;selected_company_id=<?php echo($this->companyID); ?>" title="Add Contact">                    <img src="images/actions/add_small.gif" width="16" height="16" class="absmiddle" alt="add contact" border="0" title="Add Contact"/>&nbsp;Add Location                </a>-->                                <a href="javascript:void(0);" onclick="showPopWin('<?php echo(CATSUtility::getIndexName()); ?>?m=companies&amp;a=addCompanyLocation&amp;companyID=<?php echo($this->companyID); ?>&amp;operation=add', 400, 350, null);" style="">                <img src="images/actions/add_small.gif" width="16" height="16" class="absmiddle" alt="add contact" border="0" title="Add Contact"/>&nbsp; Add Location                </a>            <?php endif; ?>            <!-- /LOCATION INFO -->
        </div>
    </div>

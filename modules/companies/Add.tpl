...
<?php TemplateUtility::printTabs($this->active, $this->subActive); ?>
        ...
        <div id="contents">
            ...
            <form name="addCompanyForm" id="addCompanyForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=companies&amp;a=add" method="post" onsubmit="return checkAddForm(document.addCompanyForm);" autocomplete="off">
                ...
                <table class="editTable" width="100%">
                    ...
                    </tr>                    <tr>                        <td class="tdVertical">                            <label id="isImpPartner" for="isImpPartner">Implemetation partner:</label>                        </td>                        <td class="tdData">                            <input type="checkbox" id="isImpPartner" name="isImpPartner" />&nbsp;                        </td>                    </tr>
                    <tr>
                        <td class="tdVertical">
                            <label id="isHotLabel" for="isHot">Our Fee:</label>
                        </td>
                        <td class="tdData">
                            <input type="text" name="ourfee_percent" id="ourfee_percent" value="" class="inputbox" style="width: 50px" />%
                        </td>
                    </tr>
                </table>
    ...
    </div><!-- Script used to keep Company type defalut select as Client --><script language="javascript"> 	$('extraField0').ready(function() {		 	$('#extraField0').val("Client");		});</script>     

...
<?php TemplateUtility::printHeader('SuppliersContacts', array('js/sorttable.js', 'js/highlightrows.js')); ?>
        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2>SuppliersContacts: Cold Call List</h2></td>
                </tr>
            </table>
        
            <p class="note">Cold Call List (Only SuppliersContacts with Phone Numbers)</p>
                ...
                <table class="sortable" rules="all" onmouseover="javascript:trackTableHighlight(event)">
                    ...
                    <?php foreach ($this->rs as $rowNumber => $data): ?>
                        <tr class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">
                            <td valign="top" align="left"><?php $this->_($data['supplierName']); ?></td>

...
<?php TemplateUtility::printModalHeader('SuppliersContacts', array('modules/supplierscontacts/activityvalidator.js', 'js/activity.js'), 'SuppliersContacts: Log Activity'); ?>
<?php else: ?>
    <?php TemplateUtility::printModalHeader('SuppliersContacts', array('modules/supplierscontacts/activityvalidator.js', 'js/activity.js'), 'SuppliersContacts: Schedule Event'); ?>
<?php endif; ?>
...
<script type="text/javascript">
    ...
    <form name="logActivityForm" id="logActivityForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=supplierscontacts&amp;a=addActivityScheduleEvent<?php if($this->onlyScheduleEvent): ?>&amp;onlyScheduleEvent=true<?php endif; ?>" method="post" autocomplete="off">
        <input type="hidden" name="postback" id="postback" value="postback" />
        <input type="hidden" id="suppliercontactID" name="suppliercontactID" value="<?php echo($this->suppliercontactID); ?>" />
        ...
        <input type="button" class="button" name="close" value="Cancel" onclick="parentGoToURL('<?php echo(CATSUtility::getIndexName()); ?>?m=supplierscontacts&amp;a=show&amp;suppliercontactID=<?php echo($this->suppliercontactID); ?>');" />
    </form>
...
<?php else: ?>
    ...
    <form>
        <input type="button" name="close" class="button" value="Close" onclick="parentGoToURL('<?php echo(CATSUtility::getIndexName()); ?>?m=supplierscontacts&amp;a=show&amp;suppliercontactID=<?php echo($this->suppliercontactID); ?>');" />
    </form>
<?php endif; ?>

                        ...
                        <?php foreach ($this->rs as $rowNumber => $data): ?>
                            <tr class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">
                                <td valign="top" nowrap="nowrap">
                                    <input type="checkbox" id="checked_<?php echo($data['suppliercontactID']); ?>" name="checked_<?php echo($data['suppliercontactID']); ?>" />
                                    <a href="javascript:void(0);" onclick="window.open('<?php echo(CATSUtility::getIndexName()); ?>?m=supplierscontacts&amp;a=show&amp;suppliercontactID=<?php $this->_($data['suppliercontactID']); ?>')" title="View in New Window">
                                        <img src="images/new_window.gif" alt="(Preview)" border="0" width="15" height="15" />
                                    </a>
                                </td>
                                <td valign="top" align="left">
                                    <a href="<?php echo(CATSUtility::getIndexName()); ?>?m=supplierscontacts&amp;a=show&amp;suppliercontactID=<?php $this->_($data['suppliercontactID']); ?>" class="<?php $this->_($data['linkClassContact']); ?>">

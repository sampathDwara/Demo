        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2>SuppliersContacts: Contact Details</h2></td>
                </tr>
            </table>
                    ...
                    <td width="50%" height="100%">
                        <table class="detailsInside" height="100%">
                                ...
                                <td class="data">
                                    <span class="bold">
                                        <span class="<?php echo($this->data['titleClassContact']);?>">
                                            ...
                                            <?php TemplateUtility::printSingleQuickActionMenu(DATA_ITEM_CONTACT, $this->suppliercontactID); ?>
                                        </span>
                                        &nbsp;
                                        <a id="vCard" href="<?php echo(CATSUtility::getIndexName()); ?>?m=supplierscontacts&amp;a=downloadVCard&amp;suppliercontactID=<?php echo($this->suppliercontactID); ?>">
                            ...
                            <tr>
                                ...
                                <td class="data">
                                    <a href="<?php echo(CATSUtility::getIndexName()); ?>?m=suppliers&amp;a=show&amp;supplierID=<?php echo($this->data['supplierID']); ?>">
                                        <span class="<?php echo($this->data['titleClassSupplier']);?>">
                                            <?php echo($this->data['supplierName']); ?>
                                        </span>
                                    </a>
                                    <?php if ($this->data['leftSupplier']): ?>
                                        &nbsp;(no longer associated with supplier)
                                    <?php endif; ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="data">
                                    <?php if($this->data['reportsTo'] == -1 || $this->data['reportsTo'] == 0 || $this->data['reportsToTitle'] == ''): ?>
                                        (None)
                                    <?php else: ?>
                                        <a href="<?php echo(CATSUtility::getIndexName()); ?>?m=supplierscontacts&amp;a=show&amp;suppliercontactID=<?php echo($this->data['reportsTo']); ?>">
                                            <img src="images/supplierscontact_small.gif" border="0" />&nbsp;
                        ...
                        <table class="detailsInside">
                            ...
                            <tr>
                                ...
                                <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT && $this->accessLevel!= 370 ): ?>
                                    <a href="#" onclick="showPopWin('<?php echo(CATSUtility::getIndexName()); ?>?m=supplierscontacts&amp;a=addActivityScheduleEvent&amp;suppliercontactID=<?php echo($this->suppliercontactID); ?>&amp;onlyScheduleEvent=true', 600, 200, null); return false;">
            ...
            <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT && $this->accessLevel!= 370 ): ?>
                <a id="edit_link" href="<?php echo(CATSUtility::getIndexName()); ?>?m=supplierscontacts&amp;a=edit&amp;suppliercontactID=<?php echo($this->suppliercontactID); ?>">
            ...
            <?php if ($this->accessLevel >= ACCESS_LEVEL_DELETE && $this->accessLevel!= 370 ): ?>
                <a id="delete_link" href="<?php echo(CATSUtility::getIndexName()); ?>?m=supplierscontacts&amp;a=delete&amp;suppliercontactID=<?php echo($this->suppliercontactID); ?>" onclick="javascript:return confirm('Delete this candidate?');">
            ...
            <?php if ($this->privledgedUser): ?>
                <a id="history_link" href="<?php echo(CATSUtility::getIndexName()); ?>?m=settings&amp;a=viewItemHistory&amp;dataItemType=300&amp;dataItemID=<?php echo($this->suppliercontactID); ?>">
            ...
            <table id="activityTable" class="sortable">
                ...
                <?php foreach ($this->activityRS as $rowNumber => $activityData): ?>
                    <tr class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">
                        ...
                        <td align="center" >
                            <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT && $this->accessLevel!= 370 ): ?>
                                <a href="#" id="editActivity<?php echo($activityData['activityID']); ?>" onclick="Activity_editEntry(<?php echo($activityData['activityID']); ?>, <?php echo($this->suppliercontactID); ?>, <?php echo(DATA_ITEM_CONTACT); ?>, '<?php echo($this->sessionCookie); ?>'); return false;">
            ...
            <div id="addActivityDiv">
                <?php if ($this->accessLevel >= ACCESS_LEVEL_EDIT && $this->accessLevel!= 370 ): ?>
                    <a href="#" id="addActivityLink" title="Log an Activity / Schedule Event" onclick="showPopWin('<?php echo(CATSUtility::getIndexName()); ?>?m=supplierscontacts&amp;a=addActivityScheduleEvent&amp;suppliercontactID=<?php echo($this->suppliercontactID); ?>', 600, 375, null); return false;">

...
class SuppliersContactsListByViewDataGrid extends SuppliersContactsDataGrid
{
    public function __construct($siteID, $parameters, $misc)
    {
        ...
        parent::__construct("supplierscontacts:SuppliersContactsListByViewDataGrid", 
...
class supplierscontactSavedListByViewDataGrid extends SuppliersContactsDataGrid
{
    public function __construct($siteID, $parameters, $misc)
    {
        /* Pager configuration. */
        ...
        parent::__construct("supplierscontacts:supplierscontactSavedListByViewDataGrid", 
                             $siteID, $parameters, $misc
                        );
    }

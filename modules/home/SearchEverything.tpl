    ...
    <div id="main">
        ...
        <div id="contents">
            ...
            <?php if (!empty($this->candidatesRS)): ?>
                <table class="sortable" width="100%">
                    <tr>
                        <th align="left" width="65">First Name</th>
                        <th align="left" width="65">Last Name</th>
                        <th align="left" width="65">Home</th>
                        
                        <th align="left" width="65">Owner</th>
                        <th align="left" width="65">Created</th>
                        <th align="left" width="65">Modified</th>
                    </tr>

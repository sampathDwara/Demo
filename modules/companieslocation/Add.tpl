...
<?php TemplateUtility::printHeader('CompaniesLocation', array('modules/companieslocation/validator.js', 'js/company.js', 'js/sweetTitles.js', 'js/listEditor.js',  'js/contact.js', 'js/suggest.js')); ?>

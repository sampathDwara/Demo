                    ...
                    <tbody><tr>
                        <td width="50%" height="100%" valign="top">
                            ...
                            <table class="editTable" width="100%">
                                ...
                                <tr>                                    <td class="tdVertical">                                        <label id="clientRefLabel" for="clientrefno">Client Ref.No:</label>                                    </td>                                    <td class="tdData">                                        <input type="text" tabindex="1" class="inputbox" id="clientrefno" name="clientrefno" style="width: 150px;" <?php if(isset($this->jobOrderSourceRS['clientrefno'])): ?>value="<?php $this->_($this->jobOrderSourceRS['clientrefno']); ?>"<?php endif; ?> />&nbsp;                                    </td>                                </tr>
                        ...
                        <td width="50%" height="100%" valign="top">                                                <p class="noteUnsized">Client / Implemenation  Partner</p>
                           ...
                           <tr>
                            <td class="tdVertical">
                                <label id="contactIDLabel" for="contactID">Primary Contact:</label>
                            </td>
                            <td class="tdData">

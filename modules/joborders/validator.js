...
function checkAddForm(form)
{
    ...
    errorMessage += checkPublicTitle();
    errorMessage += checkPublicDesc();
    errorMessage += checkDisclaimer();
...
function checkDisclaimer()
{
    ...
    fieldValue = document.getElementById('disclaimer').checked;
    fieldLabel = document.getElementById('DisclaimerLabel');
    if (!fieldValue)
    {
        errorMessage = "    - You must check Disclaimer\n";
...
function checkPublicTitle()
{
    var errorMessage = '';

    fieldValue = document.getElementById('pubtitle').value;
    fieldLabel = document.getElementById('pubtitleLabel');
    if (fieldValue == '')
    {
        errorMessage = "    - You must enter a job public title.\n";
...
function checkPublicDesc()
{
    var errorMessage = '';

    fieldValue = document.getElementById('pdescription').value;
    fieldLabel = document.getElementById('pdescriptionLabel');
    if (fieldValue == '')
    {
        errorMessage = "    - You must enter a job public description.\n";

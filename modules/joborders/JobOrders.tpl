                    ...
                    <td align="right">
                        <form name="jobOrdersViewSelectorForm" id="jobOrdersViewSelectorForm" action="<?php echo(CATSUtility::getIndexName()); ?>" method="get">
                            ...
                            <table class="viewSelector">
                                <tr>
                                    <td>
                                    <select  name="view" id="view" onchange="<?php echo($this->dataGrid->getJSAddFilter('Status', '==', 'this.value', 'true')); ?>" class="selectBox">                                                	                                    <option value="Active / On-Hold Or Manager reviewing resumes / Full / Own"<?php if ($this->dataGrid->getFilterValue('Status') == 'Active / On-Hold Or Manager reviewing resumes / Full'): ?> selected="selected"<?php endif; ?>>Active / On Hold / Full / Own</option> 	
	                                    <option <?php if ($this->dataGrid->getFilterValue('Status') == 'Active'): ?>selected<?php endif; ?> value="Active">Active</option>	
	                                    <option <?php if ($this->dataGrid->getFilterValue('Status') == 'On-Hold Or Manager reviewing resumes' || $this->dataGrid->getFilterValue('Status') == 'On-Hold Or Manager reviewing resumes'): ?>selected<?php endif; ?> value="On-Hold Or Manager reviewing resumes">On-Hold/Manager reviewing resumes</option>	
	                                    <option <?php if ($this->dataGrid->getFilterValue('Status') == 'Interviewing Candidates'): ?>selected<?php endif; ?> value="Interviewing Candidates">Interviewing Candidates</option>	
	                                    <option <?php if ($this->dataGrid->getFilterValue('Status') == 'Candidate Selected Or Onboarding'): ?>selected<?php endif; ?> value="Candidate Selected Or Onboarding">Candidate Selected Or Onboarding</option>	
	                                    <option <?php if ($this->dataGrid->getFilterValue('Status') == 'Own'): ?>selected<?php endif; ?> value="Own">Own</option>	
	                                    <option <?php if ($this->dataGrid->getFilterValue('Status') == 'Closed'): ?>selected<?php endif; ?> value="Closed">Closed</option>	
	                                    <option <?php if ($this->dataGrid->getFilterValue('Status') == 'Cancelled'): ?>selected<?php endif; ?> value="Cancelled">Cancelled</option>	
	                                    <option <?php if ($this->dataGrid->getFilterValue('Status') == 'Closure Lost'): ?>selected<?php endif; ?> value="Closure Lost">Closure Lost</option>                                 	                                    	                                    <option <?php if ($this->dataGrid->getFilterValue('Status') == 'Lost'): ?>selected<?php endif; ?> value="Lost">Lost</option>											<option <?php if ($this->dataGrid->getFilterValue('Status') == 'Full'): ?>selected<?php endif; ?> value="Full">Full</option>	
	                                    <!--option <?php if ($this->dataGrid->getFilterValue('Status') == 'Upcoming'): ?>selected<?php endif; ?> value="Upcoming">Upcoming</option>	
	                                    <option <?php if ($this->dataGrid->getFilterValue('Status') == 'Lead'): ?>selected<?php endif; ?> value="Lead">Prospective / Lead</option>                                  	
	                                    <option <?php if ($this->dataGrid->getFilterValue('Status') == 'Full'): ?>selected<?php endif; ?> value="Full">Full</option-->										    <option <?php if ($this->dataGrid->getFilterValue('Status') == 'Active/On-Hold Or Manager reviewing resumes/Interviewing Candidates/Candidate Selected Or Onboarding/Own/Closed/Cancelled/Closure Lost/Lost/Upcoming/Lead/Full'): ?> selected="selected"<?php endif; ?> value="Active/On-Hold Or Manager reviewing resumes/Interviewing Candidates/Candidate Selected Or Onboarding/Own/Closed/Cancelled/Closure Lost/Lost/Upcoming/Lead/Full" >All</option>

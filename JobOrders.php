...
class JobOrders
{
     ...
     */
    public function add($title,$pubtitle, $companyID, $contactID, $description, $notes,
        $duration, $maxRate,$payRate, $type, $isHot, $public, $openings, $companyJobID,
        $salary,$country, $city, $state, $startDate, $endDate, $enteredBy, $recruiter, $owner,
    ...
    public function update($jobOrderID, $title, $pubtitle, $companyJobID, $companyID,
        $contactID, $description, $notes, $duration, $maxRate, $payRate, $type, $isHot,
        $openings, $openingsAvailable, $salary, $country, $city, $state, $startDate, $endDate, $status, $recruiter,

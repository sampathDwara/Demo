...
/* Get an array of the supplier's contacts data. */
$supplier = new Suppliers($siteID);
$supplierContactsArray = $supplier->getSupplierContactsArray($supplierID);
...
foreach ($supplierContacts as $rowIndex => $row)
{
    $output .=
        "    <contact>\n" .
        "        <id>"        . $contactsArray[$rowIndex]['suppliercontactID'] . "</id>\n" .

...
include_once('UserAccessValidation.php');
...

{
    ...
    */
    ...
    
    {
        ...
        echo '<td rowspan="2"><img src="images/staidlogic.png" width="140px" border="0" alt="CATS Applicant Tracking System" /></td>', "\n";
    ...
    
    {
        ...
        */
        ...
        
        {
            ...
            if($moduleName=='activity')  continue;
            
            // if($moduleName=='suppliers')  continue;
            
            /*******************************************************************************/
            
            
            
            $currentUserId = $_SESSION['CATS']->getUserID();
            
            $userAccessValidation = new UserAccessValidation($siteID);
            
            $userRoleRS = $userAccessValidation -> getUserRole($currentUserId);
            
            $userRole = $userRoleRS[0]['role_id'];
            ...
            if($currentUserId != 1)
            {
                ...
                $moduleIdRS = $userAccessValidation ->getModuleID($moduleName);
                
                $moduleId = $moduleIdRS[0]['module_schema_id'];
                
                $moduleAccessRS = $userAccessValidation ->varifyAccess($userRole, $moduleId);
                
                $moduleAccess = $moduleAccessRS[0]['count'];
            ...
            /******************************************************************************/
            if(($moduleName=='suppliers' && $_SESSION['CATS']->getAccessLevel() == 370) || ($moduleName=='supplierscontacts' && $_SESSION['CATS']->getAccessLevel() == 370) || ($moduleName=='reports' && $_SESSION['CATS']->getAccessLevel() == 370)  || ($moduleName=='settings' && $_SESSION['CATS']->getAccessLevel() == 370)){
            ...
            if($moduleName=='settings' && $_SESSION['CATS']->getAccessLevel() == 390){
            ...
            
            {
                ...
                if("contacts" == $active->getModuleName() && $moduleName=='companies' ){
                ...
                if("supplierscontacts" == $active->getModuleName() && $moduleName=='suppliers'){
                ...
                
                {
                    ...
                    if($moduleName=='contacts' || $moduleName=='supplierscontacts'){
                        
                        
                        
                    }else{
                        
                        //if($tabText=="Companies")$tabText="Clients";
                        if($tabText=="Companies")$tabText="Companies";
            ...
            * closed after subtabs are printed. */
            ...
            
            {
                ...
                if("contacts" == $active->getModuleName() ){
                    
                    echo '<li><a href="index.php?m=companies&amp;a=add" style="">Add Company</a></li>
                        
			     <li><a href="index.php?m=companies&amp;a=search" style="">Search Companies</a></li>
                        
			     <li><a href="index.php?m=companies&amp;a=internalPostings" style="">Go To My Company</a></li>
                        
';
                    
                }
                
                if( "supplierscontacts" == $active->getModuleName()  ){
                    
                    echo '<li><a href="index.php?m=suppliers&amp;a=add" style="">Add Supplier</a></li>
                        
<li><a href="index.php?m=suppliers&amp;a=search" style="">Search Suppliers</a></li>
                        
<li><a href="index.php?m=suppliers&amp;a=internalPostings" style="">Go To My Supplier</a></li>
...
';
                ...
                { //echo "$subTabText | ";
                    ...
                    if($_SESSION['CATS']->getAccessLevel() == 370
                        
                        && ($subTabText =="Add Job Order" ||
                            
                            $subTabText =="Add Contact"  ||
                            
                            $subTabText =="Add Company"
                            
                            //||  $subTabText =="Add Supplier"
                ...
                if($moduleName == "companies" ){
                    ...
                    echo '<li><a href="index.php?m=contacts&amp;a=add" style="">Add Contact</a></li>
                        
                        <li><a href="index.php?m=contacts&amp;a=search" style="">Search Contacts</a></li>
                        
                        <li><a href="index.php?m=contacts&amp;a=showColdCallList" style="">Cold Call List</a></li>
                ...
                if($moduleName == "suppliers" ){
                    ...
                    echo '<li><a href="index.php?m=supplierscontacts&amp;a=add" style="">Add Contact</a></li>
                        
    <li><a href="index.php?m=supplierscontacts&amp;a=search" style="">Search Supplier Contacts</a></li>
                        
    <li><a href="index.php?m=supplierscontacts&amp;a=showColdCallList" style="">Cold Call List</a></li>
    ...
    ';
        ...
        echo '<li><a class="'.$className.'" href="index.php?m=activity">Activities</a></li>';
    ...
    */
    ...
    
    {
        ...
        */
        ...
        echo '<p id="footerText">ATS Version ', CATS_VERSION, $buildString,
        
        '. <span id="toolbarVersion"></span><a target="_new" href="http://www.staidlogic.com/"><strong>StaidLogic LLC</strong></a>.</p>', "\n";
    ...
    */
    ...
    
    {
        ...
        echo '<title>Application Tracting System - ', $pageTitle, '</title>', "\n";
        ...
        echo '<script type="text/javascript" src="js/jquery-2.1.1.js'.$javascriptAntiCache.'"></script>', "\n";
        
        echo '<script type="text/javascript" src="js/bootstrap.min.js'.$javascriptAntiCache.'"></script>', "\n";

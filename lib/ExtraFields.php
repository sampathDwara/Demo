            ...
            switch ($data['extraFieldType'])
            {
                ...
                case EXTRA_FIELD_RADIO:
                    ...
                    foreach($options as $option)
                    {
                        if ($option != '')
                        {
                            if(urldecode($option)=="NO")
                        	$checkedoption=' checked ';
                        	else $checkedoption='';
                        	
                           $extraFields[$index]['addHTML'] .= '<input type="radio" name="extraField'.$index.'" '. $checkedoption. '  value="'.htmlspecialchars(urldecode($option)).'">'.htmlspecialchars(urldecode($option)).'<br \>';
                        }
                    }
                break;
            ...
            switch ($data['extraFieldType'])
            {
                ...
                case EXTRA_FIELD_RADIO:
                    ...
                    foreach($options as $option)
                    {
                        if ($option != '')
                        {
                        	if(urldecode($option) == $data['value'])
                        	$checkedoption=' checked ';
                        	else if($data['value']=="" && urldecode($option)=="NO")
                        	$checkedoption=' checked ';
                        	else $checkedoption='';
                        	
                           $extraFields[$index]['editHTML'] .= '<input type="radio" name="extraField'.$index.'" value="'.htmlspecialchars(urldecode($option)).'" '.$checkedoption.'>'.htmlspecialchars(urldecode($option)).'<br \>';
                        }
                    }
                break;

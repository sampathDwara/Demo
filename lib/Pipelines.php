...
class Pipelines
{
     ...
     * @return array pipeline data
     */
    public function getActivityData($candidateID, $jobOrderID)
    {
        $sql = sprintf(
            "SELECT
                *
                ...
                (
                    SELECT
                        CONCAT(
                            ...
                            IF(
                                ISNULL(activity.contact_pay_current) OR activity.contact_pay_current = '',
                                'N/A',
                                activity.contact_pay_current
                            )
                             ,' Desired Pay:',
                            IF(
                                ISNULL(activity.contact_pay_expectation) OR activity.contact_pay_expectation = '',
                                'N/A',

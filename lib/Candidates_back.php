...
class Candidates
{
     ...
     */
    public function add($firstName, $middleName, $lastName,$supplierID, $supplierContactsID, $email1, $email2,
        ...
        $currentPay, $desiredPay, $currentPaySal, $desiredPaySal, $notes, $webSite, $bestTimeToCall, $enteredBy, $owner,
        $gender = '', $race = '', $veteran = '', $disability = '',
        $skipHistory = false)
    {
       
      /* echo "$firstName, $middleName, $lastName, $email1, $email2,
        $phoneHome, $phoneCell, $phoneWork, $address, $country, $city, $state, $zip,
        $source, $keySkills, $otherSkills, $dateAvailable, $currentEmployer, $canRelocate,
        $currentPay, $desiredPay, $currentPaySal, $desiredPaySal, $notes, $webSite, $bestTimeToCall, $enteredBy, $owner,
        $gender = '', $race = '', $veteran = '', $disability = '',
        $skipHistory = false,$supplierID,$supplierContactsID";*/
        $sql = sprintf(
            ...
            $this->_db->makeQueryString($currentPaySal),
            $this->_db->makeQueryString($desiredPaySal),
     ...
     */
    public function update($candidateID, $supplierID, $supplierContactsID, $isActive, $firstName, $middleName, $lastName, $email1, $email2, $phoneHome, $phoneCell, $phoneWork, $address,
        $country, $city, $state, $zip, $source, $keySkills, $otherSkills, $dateAvailable,
        $currentEmployer, $canRelocate, $currentPay, $desiredPay, $currentPaySal, $desiredPaySal,
    ...
    public function getForEditing($candidateID)
    {
        $sql = sprintf(
            "SELECT
                ...
                candidate.suppliercontact_id AS suppliercontactID,
                candidate.is_active AS isActive,
                candidate.first_name AS firstName,
                candidate.middle_name AS middleName,
                candidate.last_name AS lastName,
                ...
                candidate.current_pay AS currentPay,
                candidate.desired_pay AS desiredPay,
                candidate.current_pay_sal AS currentPaySal,
                candidate.desired_pay_sal AS desiredPaySal,
                candidate.notes AS notes,
                candidate.owner AS owner,
                candidate.can_relocate AS canRelocate,
                candidate.web_site AS webSite,
